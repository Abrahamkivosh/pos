					...
					<div class="row">
						...
						<div class="col-md-12">
					        <div class="form-group">
						        ...
						        <input type="file" class="dropify" name="header_footer_page_media[payment_gateway_image]" data-default-file="{{ isset($pageMedia->payment_gateway_image) ? asset('uploads/media/'.$pageMedia->payment_gateway_image) : '' }}">
					        </div>
					    </div>
