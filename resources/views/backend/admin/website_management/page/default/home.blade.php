					...
					<div class="row">
						...
						<div class="col-md-12">
					        <div class="form-group">
						        ...
						        <input type="file" class="dropify" name="home_page_media[hero_image]" data-default-file="{{ isset($pageMedia->hero_image) ? asset('uploads/media/'.$pageMedia->hero_image) : '' }}">
					        </div>
					    </div>
						...
						<div class="col-md-12">
					        <div class="form-group">
						        ...
						        <input type="file" class="dropify" name="home_page_media[newsletter_bg_image]" data-default-file="{{ isset($pageMedia->newsletter_bg_image) ? asset('uploads/media/'.$pageMedia->newsletter_bg_image) : '' }}">
					        </div>
					    </div>
