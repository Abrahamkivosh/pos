					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify" name="profile_picture" data-default-file="{{ asset('uploads/profile/'.$vendor->profile_picture) }}" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
							</div>
						</div>
