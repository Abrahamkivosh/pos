					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify" name="image" data-default-file="{{ asset('uploads/media/'.$product->image) }}" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG">
							</div>
						</div>
